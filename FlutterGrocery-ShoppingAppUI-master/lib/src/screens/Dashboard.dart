  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title:
              Text('Club Terraza', style: logoWhiteStyle, textAlign: TextAlign.center),
          actions: <Widget>[
            IconButton(
    ...
    children: <Widget>[
      ...
      Container(
        ...
        child: FlatButton(
          ...
          child: Text('Ver todo ›', style: contrastText),
        ),
      )
    ],
  );
    ...
    children: <Widget>[
      ...
      SizedBox(
        ...
        child: ListView(
          ...
          shrinkWrap: true,
          children: <Widget>[
            headerCategoryItem('Fritos', Fryo.dinner, onPressed: () {}),
            headerCategoryItem('Comida rápida', Fryo.food, onPressed: () {}),
            headerCategoryItem('Lechería', Fryo.poop, onPressed: () {}),
            headerCategoryItem('Bebidas calientes', Fryo.coffee_cup, onPressed: () {}),
            headerCategoryItem('Vegetales', Fryo.leaf, onPressed: () {}),
          ],
        ),
      )
    ],
